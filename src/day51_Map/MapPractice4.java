...
*/
        System.out.println("-----------------------------------------------------");
        System.out.println("second name from group that has 2 key=> "+ groups.get(2).get(1));//returns the name  that is second name index1 with get() from the group that the given key named 2
