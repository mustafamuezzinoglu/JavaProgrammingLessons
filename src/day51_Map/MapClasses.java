...
//        Key  , Value
       ...
       System.out.println(hashMap.get(5)); //no index number but based on key it gives result
...
//      treeMap.put(null,"Hulya");      it gives error because treeMap doesnt accept NULL
