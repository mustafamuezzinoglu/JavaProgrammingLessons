...
public class ArraysUtility {
    ...
    //  2  prints each decimal number of a double array in separate lines
    ...
    //removes the index from the array,returns the new array {1,2,3,4}  ,    2
    public static int[] removeElement(int[] array, int index) {
        ...
        int[] result = new int[array.length - 1];//{1,2,4}
    ...
    //replaces all matching old values of the array with the new value
