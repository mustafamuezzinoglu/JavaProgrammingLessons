...
public class ArrayPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(numbers)); //arrays.tostring ile array içindeki elementleri array formatında yazdırır

        System.out.println("--------------------------------");
        // create a variable that can contain 5 scores

        int[] scores = new int[5]; //içinde 5 element bulunan int formatında array oluşturmak için
//her bibr elementi ayrı ayrı belirtmek istersek aşağıdaki metod
        scores[1]= 85;
        ...
        String[] months = {"January", "February", "March", "April", "May", "June", "July",
                "August", "September", "October", "November", "December"};  //0 ~ 11 (length -1) length 12 ama son element 11
